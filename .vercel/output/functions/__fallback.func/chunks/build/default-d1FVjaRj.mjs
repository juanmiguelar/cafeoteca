...
import { e as ssrRenderAttrs_1, a as ssrRenderComponent_1, k as ssrRenderSlot_1, j as ssrRenderAttr_1, f as ssrRenderList_1, i as ssrInterpolate_1, l as ssrRenderTeleport_1, p as publicAssetsURL } from '../routes/renderer.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent_1(_component_NuxtLink, {
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr_1("src", _imports_0)} alt="Cafeoteca Logo" class="h-10 w-auto" data-v-72f5f464${_scopeId}>`);
          } else {
            return [
      ...
      ssrRenderList_1(navLinks, (link) => {
        _push(ssrRenderComponent_1(_component_NuxtLink, {
          ...
          default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate_1(link.label)}`);
            } else {
              return [
          ...
          ssrRenderList_1(navLinks, (link) => {
            _push2(ssrRenderComponent_1(_component_NuxtLink, {
              ...
              default: vueExports.withCtx((_, _push3, _parent2, _scopeId) => {
                if (_push3) {
                  _push3(`${ssrInterpolate_1(link.label)}`);
                } else {
                  return [
                    vueExports.createTextVNode(vueExports.toDisplayString(link.label), 1)
                  ];
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  const _component_NuxtLink = __nuxt_component_0$1;
  _push(`<footer${ssrRenderAttrs_1(vueExports.mergeProps({ class: "bg-surface-dark text-white mt-12" }, _attrs))}><div class="max-w-7xl mx-auto px-6 lg:px-8 py-10 lg:py-14"><div class="lg:flex lg:justify-between lg:items-start lg:gap-12"><div class="text-center lg:text-left mb-8 lg:mb-0">`);
  _push(ssrRenderComponent_1(_component_NuxtLink, {
    to: "/",
    ...
    default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${ssrRenderAttr_1("src", _imports_0)} alt="Cafeoteca" class="h-12 w-auto brightness-0 invert mx-auto lg:mx-0"${_scopeId}>`);
      } else {
        return [
          vueExports.createVNode("img", {
            src: _imports_0,
