import { _ as __nuxt_component_0$1 } from './nuxt-link-kW0f31pn.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_NuxtLink, {
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${serverRenderer_cjs_prodExports.ssrRenderAttr("src", _imports_0)} alt="Cafeoteca Logo" class="h-10 w-auto" data-v-72f5f464${_scopeId}>`);
          } else {
            return [
          ...
          serverRenderer_cjs_prodExports.ssrRenderList(navLinks, (link) => {
            _push2(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_NuxtLink, {
              ...
              default: vueExports.withCtx((_, _push3, _parent2, _scopeId) => {
                if (_push3) {
                  _push3(`${serverRenderer_cjs_prodExports.ssrInterpolate(link.label)}`);
                } else {
                  return [
                    vueExports.createTextVNode(vueExports.toDisplayString(link.label), 1)
                  ];
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  const _component_NuxtLink = __nuxt_component_0$1;
  _push(`<footer${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "bg-surface-dark text-white mt-12" }, _attrs))}><div class="max-w-7xl mx-auto px-6 lg:px-8 py-10 lg:py-14"><div class="lg:flex lg:justify-between lg:items-start lg:gap-12"><div class="text-center lg:text-left mb-8 lg:mb-0">`);
  _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_NuxtLink, {
    to: "/",
    ...
    default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${serverRenderer_cjs_prodExports.ssrRenderAttr("src", _imports_0)} alt="Cafeoteca" class="h-12 w-auto brightness-0 invert mx-auto lg:mx-0"${_scopeId}>`);
      } else {
        return [
          vueExports.createVNode("img", {
            src: _imports_0,
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_AppHeader, null, null, _parent));
  _push(`<main class="max-w-7xl mx-auto">`);
  serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
  _push(`</main>`);
  _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_AppFooter, null, null, _parent));
...
//# sourceMappingURL=default-DdlvCKVu.mjs.map
