import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, getCurrentInstance, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, defineAsyncComponent, computed, unref, shallowReactive, ref, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, toRef, withCtx, nextTick, isReadonly, toValue, useSSRContext, isRef, isShallow, isReactive, toRaw, watch } from 'vue';
import { k as hasProtocol, l as isScriptProtocol, h as joinURL, w as withQuery, m as defu, s as sanitizeStatusCode, n as getContext, $ as $fetch, e as createError$1, o as executeAsync, p as withoutTrailingSlash, t as titleCase, q as camelCase, r as withTrailingSlash, v as stringifyQuery, x as parseURL, y as withLeadingSlash, z as withBase } from '../nitro/nitro.mjs';
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-d1FVjaRj.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-C6Itz7WM.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-i710Wme0.mjs'));
