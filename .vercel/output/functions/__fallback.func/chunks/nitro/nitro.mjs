...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "6a46ddcc-8125-48f5-ba05-ae4f4fe4ec14",
...
const _HHELznRLPmfSzSuVFT2LT_NCu4v0GcWWkO_sKbI5ic = defineNitroPlugin(async (nitroApp) => {
...
const _X62CNEtnrjdCu1zNXermuRNJciZZYvt_LZtc4u7gFe0 = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _HHELznRLPmfSzSuVFT2LT_NCu4v0GcWWkO_sKbI5ic,
_X62CNEtnrjdCu1zNXermuRNJciZZYvt_LZtc4u7gFe0
];
...
const __OwAw9 = eventHandler(async (e) => {
...
const _SUt4S1 = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _UjfmD0 = defineEventHandler(async (e) => {
...
const _yXL1hc = defineEventHandler(async (e) => {
...
const _i72BdM = defineEventHandler(sitemapXmlEventHandler);

const _lazy_BsFw7y = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_BsFw7y, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '', handler: __OwAw9, lazy: false, middleware: true, method: undefined },
  { route: '/robots.txt', handler: _SUt4S1, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _UjfmD0, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _yXL1hc, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _i72BdM, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_BsFw7y, lazy: true, middleware: false, method: undefined }
];
